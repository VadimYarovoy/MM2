...
for test_num, test_case in enumerate(test_cases):
    ...
    g1 = get_g1(a, chi1, k1, u)
    g2 = get_g2(b, u)
    g3 = get_g3(c, chi3, k2, u)
    g4 = get_g4(d, chi4, k2, u)
    ...
    mod = Model(a, b, c, d, [k1, k2], f, [chi1, chi3, chi4], [g1, g2, g3, g4])
    ...
    for Nx, Ny in sizes:
        ...
        y, n_steps_1 = conjgrad(A, g, x0, eps=1e-8)
